...
export const EventPage = () => {
    ...
    const fetchEvent = async () => {
      try {
        const response = await fetch(
          ` https://my-json-server.typicode.com/TD2402/Json-server/events${eventId}`
        );
        ...
        const categoryPromises = categoryIds.map(async (categoryId) => {
          const categoryRespone = await fetch(
            `https://my-json-server.typicode.com/TD2402/Json-server/categories/${categoryId}`
          );
        ...
        const userResponse = await fetch(
          `https://my-json-server.typicode.com/TD2402/Json-server/users/${eventData.createdBy}`
        );
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch(
        `hhttps://my-json-server.typicode.com/TD2402/Json-server/events${eventId}`,
        {
